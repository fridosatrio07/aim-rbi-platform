...
export const NAVIGATION_ITEMS: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Standards Knowledge", href: "/administration/standards" },
      { label: "Rules", href: "/administration/rules" },
      { label: "Evidence Requirements", href: "/administration/evidence-requirements" },
      { label: "Analysis Sandbox", href: "/administration/analysis-sandbox" },
